<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebSitesExtensionsControl.ascx.cs" Inherits="WebsitePanel.Portal.WebSitesExtensionsControl" %>
...
<table cellpadding="4">
    ...
    <tr id="rowAspNet" runat="server">
        ...
        <td class="Normal">
            <asp:DropDownList ID="ddlAspNet" runat="server" CssClass="NormalTextBox" resourcekey="ddlAspNet">
