<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SettingsWebPolicy.ascx.cs" Inherits="WebsitePanel.Portal.SettingsWebPolicy" %>
...
<wsp:CollapsiblePanel id="secParkingPage" runat="server"
...
<asp:Panel ID="ParkingPagePanel" runat="server" Height="0" style="overflow:hidden;">
    <table width="100%">
        ...
        <tr>
            ...
            <td class="Normal">
                <asp:TextBox ID="txtPageName" runat="server" Width="200" CssClass="NormalTextBox"></asp:TextBox></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="Normal">
                <asp:TextBox ID="txtDefaultDocs" runat="server" TextMode="MultiLine"
	                                        Rows="7" CssClass="NormalTextBox" Width="200px"></asp:TextBox>
            </td>
        </tr>
    </table>
</asp:Panel>
...
<wsp:CollapsiblePanel id="secGeneralSettings" runat="server"
...
<asp:Panel ID="ExtensionsPanel" runat="server" Height="0" style="overflow:hidden;">
    <table cellpadding="4">
        ...
        <tr>
            ...
            <td class="Normal">
                <asp:DropDownList ID="ddlAspNet" runat="server" CssClass="NormalTextBox" meta:resourcekey="ddlAspNet">
        ...
        <tr>
            ...
            <td class="Normal">
                <asp:DropDownList ID="ddlPhp" runat="server" CssClass="NormalTextBox" meta:resourcekey="ddlPhp">
                    <asp:ListItem Value="">None</asp:ListItem>
...
<wsp:CollapsiblePanel id="secAnonymousAccount" runat="server"
...
<wsp:CollapsiblePanel id="secVirtualDirectories" runat="server"
    TargetControlID="VirtualDirectoriesPanel" meta:resourcekey="secVirtualDirectories" Text="Virtual Directories"/>
<asp:Panel ID="VirtualDirectoriesPanel" runat="server" Height="0" style="overflow:hidden;">
    <table>
        <tr>
            <td class="SubHead" style="width:150px;" valign="top">
...
<wsp:CollapsiblePanel id="secFrontPage" runat="server"
...
<wsp:CollapsiblePanel id="secSecuredFolders" runat="server"
...
<wsp:CollapsiblePanel id="secFolders" runat="server"
...
<asp:Panel ID="FoldersPanel" runat="server" Height="0" style="overflow:hidden;">
    <table cellpadding="4">
        ...
        <tr>
            ...
            <td class="Normal">
                <asp:TextBox ID="txtSiteRootFolder" runat="server" CssClass="NormalTextBox" Width="200"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="Normal">
                <asp:TextBox ID="txtSiteLogsFolder" runat="server" CssClass="NormalTextBox" Width="200"></asp:TextBox>
        ...
        <tr>
            ...
            <td class="Normal">
                <asp:TextBox ID="txtSiteDataFolder" runat="server" CssClass="NormalTextBox" Width="200"></asp:TextBox>
