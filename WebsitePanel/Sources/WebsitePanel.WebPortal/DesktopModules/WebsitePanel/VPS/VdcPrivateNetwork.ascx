<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VdcPrivateNetwork.ascx.cs" Inherits="WebsitePanel.Portal.VPS.VdcPrivateNetwork" %>
                    ...
                    <asp:Panel ID="QuotasPanel" runat="server" Height="0" style="overflow:hidden;">
                        ...
                        <table cellspacing="6">
                            <tr>
                                ...
                                <td><wsp:Quota ID="addressesPerVps" runat="server" QuotaName="VPS.PrivateIPAddressesNumber" /></td>
                            </tr>
                        </table>
