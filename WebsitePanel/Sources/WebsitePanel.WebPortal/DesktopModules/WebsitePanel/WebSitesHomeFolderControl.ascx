<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebSitesHomeFolderControl.ascx.cs" Inherits="WebsitePanel.Portal.WebSitesHomeFolderControl" %>
	            ...
	            <tr>
		            <td class="Normal" width="100%">
		                ...
		                <table width="100%">
				            <tr>
				                <td>
		                            <asp:textbox id="txtRedirectUrl" Runat="server" CssClass="NormalTextBox" Width="300px"></asp:textbox>
