...
<fieldset>
    ...
    <table cellpadding="2" cellspacing="0" style="margin: 10px;">
        ...
        <tr id="ServerNameRow" runat="server">
            ...
            <td>
                <asp:DropDownList ID="listHosts" runat="server" DataValueField="Path" DataTextField="Name" CssClass="NormalTextBox"
        ...
        <fieldset>
            ...
            <fieldset>
                ...
                <div class="pnlControl">
                    ...
                    <asp:TextBox ID="txtSCVMMServer" runat="server" CssClass="NormalTextBox"></asp:TextBox>
                ...
                <div class="pnlControl">
                    ...
                    <asp:TextBox ID="txtSCVMMPrincipalName" runat="server" CssClass="NormalTextBox"></asp:TextBox>
                </div>
                <div class="pnlControl">
            ...
            <fieldset>
                ...
                <div class="pnlControl">
                    <asp:Label ID="lblSCOMServer" runat="server" meta:resourcekey="lblSCOMServer" Text="Server URL"
                        CssClass="SubHead"></asp:Label>
                    <asp:TextBox ID="txtSCOMServer" runat="server" CssClass="NormalTextBox"></asp:TextBox>
                ...
                <div class="pnlControl">
                    ...
                    <asp:TextBox ID="txtSCOMPrincipalName" runat="server" CssClass="NormalTextBox"></asp:TextBox>
                </div>
                <div class="pnlControl">
...
<%--            <fieldset>
                ...
                <div class="pnlControl">
                    <asp:Label ID="lblVPServer" runat="server" meta:resourcekey="lblVPServer" Text="Server URL"
                        CssClass="SubHead"></asp:Label>
                    <asp:TextBox ID="txtVPServer" runat="server" CssClass="NormalTextBox"></asp:TextBox>
...
--%>
            ...
            <%--          <div class="pnlControl">
              ...
              <asp:TextBox ID="txtSCDPMServer" runat="server" CssClass="NormalTextBox"></asp:TextBox>
          ...
          <div class="pnlControl">
              ...
              <asp:TextBox ID="txtSCCMServer" runat="server" CssClass="NormalTextBox"></asp:TextBox>
...
<%--            <div class="pnlControl">
                ...
                <asp:TextBox ID="txtSCVMMEndPoint" runat="server" CssClass="NormalTextBox"></asp:TextBox>
            ...
            <div class="pnlControl">
                ...
                <asp:TextBox ID="txtSCOMEndPoint" runat="server" CssClass="NormalTextBox"></asp:TextBox>
...
--%>
            <%--          <div class="pnlControl">
              ...
              <asp:TextBox ID="txtSCDPMEndPoint" runat="server" CssClass="NormalTextBox"></asp:TextBox>
          ...
          <div class="pnlControl">
              ...
              <asp:TextBox ID="txtSCCMEndPoint" runat="server" CssClass="NormalTextBox"></asp:TextBox>
          ...
          <div class="pnlControl">
              ...
              <asp:TextBox ID="txtStorageEndPoint" runat="server" CssClass="NormalTextBox"></asp:TextBox>
          ...
          <div class="pnlControl">
              ...
              <asp:TextBox ID="txtCoreSvcEndpoint" runat="server" CssClass="NormalTextBox"></asp:TextBox>
