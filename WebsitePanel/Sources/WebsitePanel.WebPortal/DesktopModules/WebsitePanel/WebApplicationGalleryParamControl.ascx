<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebApplicationGalleryParamControl.ascx.cs" Inherits="WebsitePanel.Portal.WebApplicationGalleryParamControl" %>
<fieldset>
    <%-- Friendly name --%>
    <legend>
