<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VdcPrivateNetwork.ascx.cs" Inherits="WebsitePanel.Portal.VPS2012.VdcPrivateNetwork" %>
...
<div id="VpsContainer">
    <div class="Module">
	    ...
	    <div class="Left">
		    <wsp:Menu id="menu" runat="server" SelectedItem="vdc_private_network" />
	    </div>
                    ...
                    <asp:Panel ID="QuotasPanel" runat="server" Height="0" style="overflow:hidden;">
                        ...
                        <table cellspacing="6">
                            <tr>
                                ...
                                <td><wsp:Quota ID="addressesPerVps" runat="server" QuotaName="VPS2012.PrivateIPAddressesNumber" /></td>
                            </tr>
                        </table>
