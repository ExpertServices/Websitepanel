<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VpsDetailsConfiguration.ascx.cs" Inherits="WebsitePanel.Portal.VPS2012.VpsDetailsConfiguration" %>
                    ...
                    <asp:Panel ID="BiosPanel" runat="server" Height="0" style="overflow:hidden;padding:5px;">
                        <table cellspacing="5">
                            <tr>
                                ...
                                <td>
                                    <wsp:CheckBoxOption id="optionNumLock" runat="server"
