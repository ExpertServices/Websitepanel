<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VdcHome.ascx.cs" Inherits="WebsitePanel.Portal.VPS2012.VdcHome" %>
		    ...
		    <div class="Center">
			    ...
			    <div class="FormBody">
				    ...
				    <asp:ObjectDataSource ID="odsServersPaged" runat="server" EnablePaging="True"
						    ...
						    TypeName="WebsitePanel.Portal.VirtualMachines2012Helper"
