<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VpsDetailsHelp.ascx.cs" Inherits="WebsitePanel.Portal.VPS2012.VpsDetailsHelp" %>
	    ...
	    <div class="Content">
		    <div class="Center">
			    <div class="Title">
				    ...
				    <wsp:FormTitle ID="locTitle" runat="server" meta:resourcekey="locTitle" Text="Help" />
			    </div>
			    <div class="FormBody">
