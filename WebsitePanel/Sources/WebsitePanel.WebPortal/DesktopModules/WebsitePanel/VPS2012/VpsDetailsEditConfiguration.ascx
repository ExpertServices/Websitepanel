<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VpsDetailsEditConfiguration.ascx.cs" Inherits="WebsitePanel.Portal.VPS2012.VpsDetailsEditConfiguration" %>
	    ...
	    <div class="Content">
		    <div class="Center">
			    <div class="Title">
				    ...
				    <wsp:FormTitle ID="locTitle" runat="server" meta:resourcekey="locTitle" Text="Edit Configuration" />
			    </div>
			    <div class="FormBody">
