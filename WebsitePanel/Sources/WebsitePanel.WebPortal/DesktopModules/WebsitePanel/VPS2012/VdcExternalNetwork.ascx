<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="VdcExternalNetwork.ascx.cs" Inherits="WebsitePanel.Portal.VPS2012.VdcExternalNetwork" %>
                    ...
                    <asp:Panel ID="QuotasPanel" runat="server" Height="0" style="overflow:hidden;">
                        ...
                        <table cellspacing="6">
                            <tr>
                                ...
                                <td><wsp:Quota ID="addressesQuota" runat="server" QuotaName="VPS2012.ExternalIPAddressesNumber" /></td>
                            </tr>
                            <tr>
                                <td><asp:Localize ID="locBandwidthQuota" runat="server" meta:resourcekey="locBandwidthQuota" Text="Bandwidth, GB:"></asp:Localize></td>
                                <td><wsp:Quota ID="bandwidthQuota" runat="server" QuotaName="VPS2012.Bandwidth" /></td>
                            </tr>
                        </table>
