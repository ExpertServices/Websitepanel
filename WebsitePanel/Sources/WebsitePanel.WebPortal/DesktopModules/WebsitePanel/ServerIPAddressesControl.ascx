<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ServerIPAddressesControl.ascx.cs" Inherits="WebsitePanel.Portal.ServerIPAddressesControl" %>
<%@ Register Src="UserControls/UserDetails.ascx" TagName="UserDetails" TagPrefix="uc2" %>
<div class="FormButtonsBar">
    <asp:Button ID="btnAdd" runat="server" Text="Add" meta:resourcekey="btnAdd" CssClass="Button3" OnClick="btnAdd_Click" />
</div>
