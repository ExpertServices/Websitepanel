<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExchangeMailboxEmailAddresses.ascx.cs" Inherits="WebsitePanel.Portal.ExchangeServer.ExchangeMailboxEmailAddresses" %>
	...
	<div class="Module">
		...
		<div class="Content">
			<div class="Center">
				...
				<div class="FormBody">
                    <wsp:MailboxTabs id="tabs" runat="server" SelectedTab="mailbox_addresses" />
