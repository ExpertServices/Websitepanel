<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ExchangePublicFolderEmailAddresses.ascx.cs" Inherits="WebsitePanel.Portal.ExchangeServer.ExchangePublicFolderEmailAddresses" %>
	...
	<div class="Module">
		...
		<div class="Content">
			<div class="Center">
				...
				<div class="FormBody">
                    <wsp:PublicFolderTabs id="tabs" runat="server" SelectedTab="public_folder_addresses" />
