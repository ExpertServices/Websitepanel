<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SchedulesEditSchedule.ascx.cs" Inherits="WebsitePanel.Portal.SchedulesEditSchedule" %>
...
<div class="FormBody">
	<table cellspacing="0" cellpadding="4" width="100%">
        <tr>
            ...
            <td class="Normal">
                <asp:TextBox ID="txtTaskName" runat="server" Width="380px" CssClass="HugeTextBox"></asp:TextBox>
	...
	<%--
    <wsp:CollapsiblePanel id="secHistory" runat="server"
